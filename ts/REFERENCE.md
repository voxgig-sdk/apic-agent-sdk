# ApicAgent TypeScript SDK Reference

Complete API reference for the ApicAgent TypeScript SDK.
...
```ts
new ApicAgentSDK(options?: object)
```
...
#### `ApicAgentSDK.test(testopts?, sdkopts?)`
...
**Returns:** `ApicAgentSDK` instance in test mode.


### Instance Methods

#### `ParseUserAgentGet(data?: object)`

Create a new `ParseUserAgentGet` entity instance.
...
**Returns:** `ParseUserAgentGetEntity` instance.

#### `ParseUserAgentPost(data?: object)`

Create a new `ParseUserAgentPost` entity instance.
...
**Returns:** `ParseUserAgentPostEntity` instance.
...
```ts
const result = await client.ParseUserAgentGet().load({ ua: 'ua' })
```
...
Return the parent `ApicAgentSDK` instance.
