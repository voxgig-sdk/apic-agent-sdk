...
(0, node_test_1.describe)('ParseUserAgentPostEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        (0, node_assert_1.default)(null != parse_user_agent_post_ref01_data);
    });
});
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/parse_user_agent_post/ParseUserAgentPostTestData.json');
    ...
    let idmap = transform(['parse_user_agent_post01', 'parse_user_agent_post02', 'parse_user_agent_post03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
...
//# sourceMappingURL=ParseUserAgentPostEntity.test.js.map