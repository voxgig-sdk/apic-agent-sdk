...
function envOverride(m) {
    if ('TRUE' === process.env.APIC_AGENT_TEST_LIVE ||
        'TRUE' === process.env.APIC_AGENT_TEST_OVERRIDE) {
    ...
    m.APIC_AGENT_TEST_EXPLAIN = process.env.APIC_AGENT_TEST_EXPLAIN || m.APIC_AGENT_TEST_EXPLAIN;
    return m;
}
