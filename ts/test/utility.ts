...
function envOverride(m: Record<string, any>) {
  if (
    'TRUE' === process.env.APICAGENT_TEST_LIVE ||
    'TRUE' === process.env.APICAGENT_TEST_OVERRIDE
  ) {
  ...
  m.APICAGENT_TEST_EXPLAIN = process.env.APICAGENT_TEST_EXPLAIN || m.APICAGENT_TEST_EXPLAIN
