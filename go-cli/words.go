...
func registerSDKWords(r *eng.Registry, client *sdk.ApicAgentSDK) {
...
func runOp(client *sdk.ApicAgentSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
