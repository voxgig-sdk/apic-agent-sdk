...
class ParseUserAgentPostEntity
  ...
  def make
    opts = @_entopts.dup
    ParseUserAgentPostEntity.new(@_client, opts)
  end
  ...
  # @return [ParseUserAgentPost, Hash] the current ParseUserAgentPost data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of ParseUserAgentPost fields)
  def match_get
  ...
  #
  # @param reqdata [ParseUserAgentPostCreateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [ParseUserAgentPost, Hash] the created ParseUserAgentPost; raises ApicAgentError on failure
