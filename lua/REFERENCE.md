# ApicAgent Lua SDK Reference

Complete API reference for the ApicAgent Lua SDK.
...
```lua
local result, err = client:ParseUserAgentGet():load({ ua = "ua" })
```
