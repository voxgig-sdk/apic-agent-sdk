...
local ApicAgentSDK = {}
ApicAgentSDK.__index = ApicAgentSDK
...
ApicAgentSDK._make_feature = _make_feature


function ApicAgentSDK.new(options)
  local self = setmetatable({}, ApicAgentSDK)
  self.mode = "live"
  self.features = {}
  self.options = nil
...
function ApicAgentSDK:options_map()
...
function ApicAgentSDK:get_utility()
  return Utility.copy(self._utility)
end


function ApicAgentSDK:get_root_ctx()
  return self._rootctx
end


function ApicAgentSDK:prepare(fetchargs)
...
function ApicAgentSDK:direct(fetchargs)
...
-- by passing it.
function ApicAgentSDK:_raw_request(fetchargs)
  local utility = self._utility
...
function ApicAgentSDK:graphql(query, variables, ctrl)
  ...
  if type(errors) == "table" and 0 < #errors then
    ...
    res.ok = false
    res.err = "ApicAgentSDK: graphql: " .. msg
    res.graphql = errors
  end
...
function ApicAgentSDK.test(testopts, sdkopts)
  sdkopts = sdkopts or {}
  ...
  local sdk = ApicAgentSDK.new(sdkopts)
  sdk.mode = "test"
