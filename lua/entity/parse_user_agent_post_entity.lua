...
local ParseUserAgentPostEntity = {}
ParseUserAgentPostEntity.__index = ParseUserAgentPostEntity


function ParseUserAgentPostEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, ParseUserAgentPostEntity)
  self._name = "parse_user_agent_post"
  self._client = client
...
function ParseUserAgentPostEntity:get_name()
  return self._name
end


function ParseUserAgentPostEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return ParseUserAgentPostEntity.new(self._client, opts)
end
...
function ParseUserAgentPostEntity:mark_deleted()
  self._deleted = true
end


function ParseUserAgentPostEntity:deleted()
  return true == self._deleted
end


function ParseUserAgentPostEntity:data_set(args)
  if args ~= nil then
...
function ParseUserAgentPostEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function ParseUserAgentPostEntity:match_set(args)
  if args ~= nil then
...
function ParseUserAgentPostEntity:match_get()
...
function ParseUserAgentPostEntity:stream(action, args, callopts)
...
function ParseUserAgentPostEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return ParseUserAgentPostEntity
