...
local ParseUserAgentGetEntity = {}
ParseUserAgentGetEntity.__index = ParseUserAgentGetEntity


function ParseUserAgentGetEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, ParseUserAgentGetEntity)
  self._name = "parse_user_agent_get"
  self._client = client
...
function ParseUserAgentGetEntity:get_name()
  return self._name
end


function ParseUserAgentGetEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return ParseUserAgentGetEntity.new(self._client, opts)
end
...
function ParseUserAgentGetEntity:mark_deleted()
  self._deleted = true
end


function ParseUserAgentGetEntity:deleted()
  return true == self._deleted
end


function ParseUserAgentGetEntity:data_set(args)
  if args ~= nil then
...
function ParseUserAgentGetEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function ParseUserAgentGetEntity:match_set(args)
  if args ~= nil then
...
function ParseUserAgentGetEntity:match_get()
...
function ParseUserAgentGetEntity:stream(action, args, callopts)
...
function ParseUserAgentGetEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return ParseUserAgentGetEntity
