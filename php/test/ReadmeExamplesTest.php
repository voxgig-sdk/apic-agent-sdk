...
// ApicAgent SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (ApicAgentSDK::test)
...
{
    private const SDK_CLASS = 'ApicAgentSDK';
    ...
    private const SDK_BASE = 'apicagent_sdk';
