...
{
    private static function utility(): ApicAgentUtility
    {
        return new ApicAgentUtility();
    }
    ...
    private static function ctx(array $over = []): ApicAgentContext
    {
        $utility = $over['utility'] ?? self::utility();
        $client = $over['client'] ?? new PlClient(['base' => 'http://h']);
        $ctx = new ApicAgentContext([
            'client' => $client,
            'utility' => $utility,
        ], null);
        $ctx->op = new ApicAgentOperation(['name' => 'load', 'entity' => 'x']);
        foreach ($over as $k => $v) {
    ...
    {
        return ($err instanceof ApicAgentError) ? $err->sdk_code : '';
    }
    ...
    public function test_make_point_rejects_a_disallowed_operation(): void
    {
        ...
        $ctx->op = new ApicAgentOperation(['name' => 'nope', 'entity' => 'x']);
        [$point, $err] = ApicAgentMakePoint::call($ctx);
    ...
    public function test_make_point_rejects_an_operation_with_no_endpoints(): void
    {
        ...
        $ctx->op = new ApicAgentOperation(['name' => 'load', 'entity' => 'x', 'points' => []]);
        [$point, $err] = ApicAgentMakePoint::call($ctx);
        $this->assertNull($point);
    ...
    public function test_make_point_returns_the_single_point(): void
    {
        ...
        $ctx = self::ctx(['options' => ['allow' => ['op' => 'load,list,create,update,remove']]]);
        $ctx->op = new ApicAgentOperation(['name' => 'load', 'entity' => 'x', 'points' => [$point]]);
        [$got, $err] = ApicAgentMakePoint::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new ApicAgentSpec(['method' => 'GET']);
        $ctx = self::ctx();
        $ctx->out['spec'] = $preset;
        [$got, $err] = ApicAgentMakeSpec::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_response_guards_missing_spec_response_result(): void
    {
        $ctx = self::ctx([
            'spec' => null,
            'response' => new ApicAgentResponse([]),
            'result' => new ApicAgentResult([]),
        ]);
        [, $err] = ApicAgentMakeResponse::call($ctx);
        $this->assertSame('response_no_spec', self::code($err));

        $ctx = self::ctx([
            'spec' => new ApicAgentSpec([]),
            'response' => null,
            'result' => new ApicAgentResult([]),
        ]);
        [, $err] = ApicAgentMakeResponse::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'spec' => new ApicAgentSpec(['step' => 's']),
            'response' => new ApicAgentResponse(self::resp(404, null, ['x-a' => '1'])),
            'result' => new ApicAgentResult([]),
        ]);
        [, $err] = ApicAgentMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_2xx_parses_the_body_and_marks_ok(): void
    {
        $ctx = self::ctx([
            'spec' => new ApicAgentSpec(['step' => 's']),
            'response' => new ApicAgentResponse(self::resp(200, ['v' => 1])),
            'result' => new ApicAgentResult([]),
        ]);
        [, $err] = ApicAgentMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_records_to_ctrl_explain_when_explain_is_on(): void
    {
        $ctx = self::ctx([
            'spec' => new ApicAgentSpec(['step' => 's']),
            'response' => new ApicAgentResponse(self::resp(200, ['v' => 2])),
            'result' => new ApicAgentResult([]),
        ]);
        $ctx->ctrl->explain = ['on' => true];
        ApicAgentMakeResponse::call($ctx);
    ...
    {
        $preset = new ApicAgentResponse(self::resp(299));
        $ctx = self::ctx([
            'spec' => new ApicAgentSpec([]),
            'response' => new ApicAgentResponse([]),
            'result' => new ApicAgentResult([]),
        ...
        [$got, $err] = ApicAgentMakeResponse::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null, 'result' => new ApicAgentResult([])]);
        [, $err] = ApicAgentMakeResult::call($ctx);
        $this->assertSame('result_no_spec', self::code($err));

        $ctx = self::ctx(['spec' => new ApicAgentSpec([]), 'result' => null]);
        [, $err] = ApicAgentMakeResult::call($ctx);
    ...
    public function test_make_result_list_op_wraps_resdata_into_entity_instances(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new ApicAgentSpec(['step' => 's']),
            'result' => new ApicAgentResult(['ok' => true, 'resdata' => [['a' => 1], ['a' => 2]]]),
        ]);
        $ctx->op = new ApicAgentOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = ApicAgentMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_result_empty_list_yields_empty_resdata(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new ApicAgentSpec(['step' => 's']),
            'result' => new ApicAgentResult(['ok' => true, 'resdata' => []]),
        ]);
        $ctx->op = new ApicAgentOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = ApicAgentMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new ApicAgentResult(['ok' => true]);
        $ctx = self::ctx([
            'spec' => new ApicAgentSpec([]),
            'result' => new ApicAgentResult([]),
        ]);
        $ctx->out['result'] = $preset;
        [$got, $err] = ApicAgentMakeResult::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_request_guards_a_missing_spec(): void
    {
        ...
        [, $err] = ApicAgentMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $boom = new ApicAgentError('boom', 'boom');
        $utility->fetcher = function (ApicAgentContext $_c, string $_u, array $_f) use ($boom): array {
            return [null, $boom];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new ApicAgentSpec(['step' => 's', 'method' => 'GET', 'base' => 'http://h', 'parts' => ['a']]),
        ]);
        [$response, $err] = ApicAgentMakeRequest::call($ctx);
        $this->assertNull($err);
    ...
    {
        $utility = self::utility();
        $utility->fetcher = function (ApicAgentContext $_c, string $_u, array $_f): array {
            return [null, null];
        };
        $ctx = self::ctx([
            'utility' => $utility,
    ...
    public function test_make_request_a_normal_transport_response_is_wrapped(): void
    {
        ...
        [$response, $err] = ApicAgentMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertInstanceOf(ApicAgentResponse::class, $response);
    ...
    {
        $utility = self::utility();
        $utility->make_fetch_def = function (ApicAgentContext $c): array {
            return [null, $c->make_error('fetchdef_boom', 'boom')];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new ApicAgentSpec(['step' => 's', 'method' => 'GET']),
        ]);
        [$response, $err] = ApicAgentMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertNotNull($response->err);
    ...
    {
        $preset = new ApicAgentResponse(self::resp(201));
        $ctx = self::ctx(['spec' => new ApicAgentSpec([])]);
        $ctx->out['request'] = $preset;
        [$got, $err] = ApicAgentMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null]);
        [, $err] = ApicAgentMakeFetchDef::call($ctx);
    ...
    public function test_make_fetch_def_serialises_body_and_inits_missing_result(): void
    {
        ...
        [$fetchdef, $err] = ApicAgentMakeFetchDef::call($ctx);
        $this->assertNull($err);
    ...
    {
        $ctx = self::ctx(['result' => new ApicAgentResult(['ok' => true, 'resdata' => 42])]);
        $this->assertSame(42, ApicAgentDone::call($ctx));
    }

    public function test_done_raises_the_error_when_not_ok(): void
    {
        $ctx = self::ctx(['result' => new ApicAgentResult(['ok' => false])]);
        $this->expectException(ApicAgentError::class);
        ApicAgentDone::call($ctx);
    }

    public function test_make_error_returns_resdata_when_ctrl_throw_is_false(): void
    {
        $ctx = self::ctx(['result' => new ApicAgentResult(['ok' => false, 'resdata' => 'fallback'])]);
        $ctx->ctrl->throw_err = false;
        $this->assertSame('fallback', ApicAgentMakeError::call($ctx, null));
    }
    ...
    public function test_make_error_records_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->throw_err = false;
        $ctx->ctrl->explain = ['on' => true];
        ApicAgentMakeError::call($ctx, null);
    ...
    public function test_feature_add_appends_in_call_order(): void
    {
        ...
        $a = new ApicAgentBaseFeature();
        $b = new ApicAgentBaseFeature();
        ApicAgentFeatureAdd::call($ctx, $a);
        ApicAgentFeatureAdd::call($ctx, $b);
        $this->assertSame([$a, $b], $client->features);
    }

    private static function named_feature(string $name): ApicAgentBaseFeature
    {
        $f = new ApicAgentBaseFeature();
        $f->name = $name;
        return $f;
    }
    ...
    public function test_feature_add_ordering_before_after_replace(): void
    {
        ...
        ApicAgentFeatureAdd::call($ctx, $miss);
    ...
    private static function auth_ctx(array $options, ?array $headers): ApicAgentContext
    {
        $client = new PlClient($options);
        return self::ctx([
            'client' => $client,
            'spec' => $headers === null ? null : new ApicAgentSpec(['headers' => $headers]),
        ]);
    }
    ...
    public function test_prepare_auth_guards_a_missing_spec(): void
    {
        ...
        [, $err] = ApicAgentPrepareAuth::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'response' => new ApicAgentResponse(['headers' => null]),
            'result' => new ApicAgentResult([]),
        ]);
        ApicAgentResultHeaders::call($ctx);
