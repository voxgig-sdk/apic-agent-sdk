...
// ApicAgent SDK struct utility test
//
...
class StructUtilityTest extends TestCase
{
    ...
    {
        if (self::$run === null) {
            $runner = ApicAgentOmni::makeStructRunner(
        ...
        $this->runsection(
            ...
            function ($input) {
                ...
                if (is_object($store) && $haspath && Struct::undef() !== $val) {
                    ...
                    if (json_encode(ApicAgentOmni::structfix($now, Struct::undef()))
                        !== json_encode(ApicAgentOmni::structfix($val, Struct::undef()))) {
