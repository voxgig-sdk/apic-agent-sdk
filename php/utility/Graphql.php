...
class ApicAgentGraphql
{
    ...
    // equivalent.
    public static function body(ApicAgentContext $ctx): mixed
    {
    ...
    public static function errors(ApicAgentContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
