...
// ApicAgent SDK ParseUserAgentPost entity
...
class ParseUserAgentPostEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "parse_user_agent_post";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new ParseUserAgentPostEntity($this->_client, $opts);
    }

    /**
     * @param ParseUserAgentPost|array $args ParseUserAgentPost data (assoc-array) to store.
     */
    ...
    /**
     * @return ParseUserAgentPost|array The current ParseUserAgentPost data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of ParseUserAgentPost fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of ParseUserAgentPost fields).
     */
    ...
    /**
     * Create a new ParseUserAgentPost.
     *
     * @param ParseUserAgentPostCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed ParseUserAgentPostCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ParseUserAgentPost|array The created ParseUserAgentPost as an assoc-array at the
