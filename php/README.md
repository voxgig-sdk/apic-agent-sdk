...
The PHP SDK for the ApicAgent API. Provides an entity-oriented interface using PHP conventions.
...
```php
[$result, $err] = $client->ParseUserAgentGet(null)->load(["id" => "example_id"], null);
...
[$result, $err] = $client->ApicAgent(null)->load(
    ["id" => "test01"], null
);
