...
The PHP SDK for the ApicAgent API — an entity-oriented client using PHP conventions.
...
try {
    ...
    print_r($parseuseragentget->data_get());
} catch (\Throwable $err) {
...
```
php/
├── apicagent_sdk.php          -- Main SDK class
...
The main class (`apicagent_sdk.php`) exports the SDK class
