...
class ApicAgentCacheFeature extends ApicAgentBaseFeature
{
    ...
    private function _through(ApicAgentContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
