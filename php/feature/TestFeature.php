...
// ApicAgent SDK test feature

require_once __DIR__ . '/BaseFeature.php';
require_once __DIR__ . '/../utility/Param.php';

class ApicAgentTestFeature extends ApicAgentBaseFeature
{
    ...
    public function init(ApicAgentContext $ctx, array $options): void
    {
        ...
        $test_fetcher = function (ApicAgentContext $fctx, string $_fullurl, array $_fetchdef) use ($entity): array {
            ...
            if ($op->name === 'load') {
                ...
                $id = ApicAgentParam::call($fctx, 'id');
    ...
    public function makeNetsim(array $net, callable $inner): callable
    {
        ...
        return function (ApicAgentContext $fctx, string $url, array $fetchdef) use ($net, $inner, $pick_latency, $sleep): array {
            $this->_netcalls++;
            $call = $this->_netcalls;
     ...
     */
    public function buildArgs(ApicAgentContext $ctx, $op, $args): array
    {
