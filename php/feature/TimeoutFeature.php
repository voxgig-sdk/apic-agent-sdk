...
class ApicAgentTimeoutFeature extends ApicAgentBaseFeature
{
    ...
    private function _with_timeout(ApicAgentContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(ApicAgentContext $_ctx, float $ms): void
    {
        $client = $this->client;
