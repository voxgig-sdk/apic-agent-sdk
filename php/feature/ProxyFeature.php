...
class ApicAgentProxyFeature extends ApicAgentBaseFeature
{
    ...
    public function init(ApicAgentContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (ApicAgentContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
