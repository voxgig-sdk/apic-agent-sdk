...
// ApicAgent SDK clienttrack feature
...
class ApicAgentClienttrackFeature extends ApicAgentBaseFeature
{
    ...
    public function PostConstruct(ApicAgentContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'ApicAgent-SDK';
