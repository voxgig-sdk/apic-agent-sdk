...
class ApicAgentSDK
{
    ...
    public function __construct(array $options = [])
    {
        ...
        $feature_opts = ApicAgentHelpers::to_map(Struct::getprop($this->options, "feature"));
        if ($feature_opts) {
            $featureorder = Struct::getpath($this->options, "__derived__.featureorder");
            if (is_array($featureorder)) {
                foreach ($featureorder as $fname) {
                    $fopts = ApicAgentHelpers::to_map($feature_opts[$fname] ?? null);
                    if ($fopts && isset($fopts["active"]) && $fopts["active"] === true) {
                        ...
                        if (!ApicAgentFeatures::has_feature($fname)) {
                        ...
                        ($utility->feature_add)($this->_rootctx, ApicAgentFeatures::make_feature($fname));
                    }
                }
            }
        }
    ...
    {
        return ApicAgentUtility::copy($this->_utility);
    }
    ...
    public function prepare(array $fetchargs = []): mixed
    {
        ...
        $ctrl = ApicAgentHelpers::to_map(Struct::getprop($fetchargs, "ctrl")) ?? [];
        ...
        $params = ApicAgentHelpers::to_map(Struct::getprop($fetchargs, "params")) ?? [];
        $query = ApicAgentHelpers::to_map(Struct::getprop($fetchargs, "query")) ?? [];
    ...
    private function op_denied(string $op): array
    {
        ...
        return [
            "ok" => false,
            "err" => new ApicAgentError($op . "_allow",
                "ApicAgentSDK: " . $op . ": operation not allowed by" .
    ...
    private function raw_request(array $fetchargs = []): mixed
    {
        ...
        if (is_array($fetched)) {
            $status = ApicAgentHelpers::to_int(Struct::getprop($fetched, "status"));
    ...
    public function graphql(string $query, ?array $variables = null, ?array $ctrl = null): mixed
    {
        ...
        if (is_array($errors) && 0 < count($errors)) {
            ...
            $res["ok"] = false;
            $res["err"] = new ApicAgentError("graphql_error",
                "ApicAgentSDK: graphql: " . $msg);
            $res["graphql"] = $errors;
        }
    ...
    public function ParseUserAgentGet($data = null)
    {
        ...
        if ($data === null) {
            if ($this->_parse_user_agent_get === null) {
                $this->_parse_user_agent_get = new ParseUserAgentGetEntity($this, null);
            }
            return $this->_parse_user_agent_get;
        }
        return new ParseUserAgentGetEntity($this, $data);
    }
    ...
    public function ParseUserAgentPost($data = null)
    {
        ...
        if ($data === null) {
            if ($this->_parse_user_agent_post === null) {
                $this->_parse_user_agent_post = new ParseUserAgentPostEntity($this, null);
            }
            return $this->_parse_user_agent_post;
        }
        return new ParseUserAgentPostEntity($this, $data);
    }
