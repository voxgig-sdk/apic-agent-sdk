...
type Args struct {
	Entity string         `json:"entity" jsonschema:"parse_user_agent_get | parse_user_agent_post"`
	Query  map[string]any `json:"query,omitempty" jsonschema:"optional match map e.g. {\"id\":1} for load, omit for list"`
}

func registerTools(server *mcp.Server, client *sdk.ApicAgentSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "apic-agent_list",
		Description: "List records from ApicAgent. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "apic-agent_load",
		Description: "Load a single record from ApicAgent. " +
...
func runOp(client *sdk.ApicAgentSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.ApicAgentSDK, name string) (sdk.ApicAgentEntity, error) {
	switch strings.ToLower(name) {
	case "parse_user_agent_get":
		return client.ParseUserAgentGet(nil), nil
	case "parse_user_agent_post":
		return client.ParseUserAgentPost(nil), nil
