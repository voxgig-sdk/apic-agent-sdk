...
| --- | --- | --- |
| TypeScript | `@voxgig-sdk/apic-agent` | `npm install @voxgig-sdk/apic-agent` |
| Python | `voxgig-sdk-apic-agent` | `pip install voxgig-sdk-apic-agent` |
| PHP | `voxgig-sdk/apic-agent` | `composer require voxgig-sdk/apic-agent` |
| Golang | `github.com/voxgig-sdk/apic-agent-sdk/go` | `go get github.com/voxgig-sdk/apic-agent-sdk/go` |
| Ruby | `voxgig-sdk-apic-agent` | `gem install voxgig-sdk-apic-agent` |
| Lua | `voxgig-sdk-apic-agent` | `luarocks install voxgig-sdk-apic-agent` |
