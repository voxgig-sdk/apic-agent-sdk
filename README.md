...
Free REST API to detect browser, OS, device from user agent string.

Learn more about APIC Agent at [apicagent.com](https://apicagent.com).

This is an unofficial SDK for the APIC Agent public API, generated by Voxgig with [`@voxgig/sdkgen`](https://github.com/voxgig/sdkgen). It is not affiliated with, endorsed by, or sponsored by the upstream API provider.
...
This SDK exposes the API as a small set of **semantic entities** — ParseUserAgentGet and ParseUserAgentPost — that you
...
$client = ApicAgentSDK::test([
    "entity" => ["parseuseragentget" => ["test01" => []]],
]);
$parseuseragentget = $client->ParseUserAgentGet()->load(["ua" => "example"]);
```
...
| Ruby | `voxgig-sdk-apic-agent` | publish pending — [install from git tag](https://github.com/voxgig-sdk/apic-agent-sdk/releases) |
| Lua | `voxgig-sdk-apic-agent` | publish pending — [install from git tag](https://github.com/voxgig-sdk/apic-agent-sdk/releases) |
| Go CLI | `github.com/voxgig-sdk/apic-agent-sdk/go-cli` | `go install github.com/voxgig-sdk/apic-agent-sdk/go-cli/cmd/apic-agent@latest` |
| Go MCP server | `github.com/voxgig-sdk/apic-agent-sdk/go-mcp` | `go get github.com/voxgig-sdk/apic-agent-sdk/go-mcp@latest` |
...
| --- | --- | --- |
| **ParseUserAgentGet** | The ParseUserAgentGet entity (load). | `/` |
| **ParseUserAgentPost** | The ParseUserAgentPost entity (create). | `/` |
