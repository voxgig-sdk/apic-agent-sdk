...
from apicagent_sdk.apicagent_types import (
    ParseUserAgentGet,
...
class ParseUserAgentGetEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return ParseUserAgentGetEntity(self._client, opts)
    ...
    def data_get(self) -> ParseUserAgentGet:
    ...
    def match_get(self) -> ParseUserAgentGet:
    ...
    def load(self, reqmatch=None, ctrl=None) -> ParseUserAgentGet:
        utility = self._utility
        # reqmatch is optional: an entity with no id-like key loads with no
        # match. Treat None as an empty match so client.ParseUserAgentGet().load()
        # works with no args.
        if reqmatch is None:
            reqmatch = {}
