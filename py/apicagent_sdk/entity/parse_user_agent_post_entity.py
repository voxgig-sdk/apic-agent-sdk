...
class ParseUserAgentPostEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return ParseUserAgentPostEntity(self._client, opts)
    ...
    def data_get(self) -> ParseUserAgentPost:
    ...
    def match_get(self) -> ParseUserAgentPost:
    ...
    def create(self, reqdata: ParseUserAgentPostCreateData, ctrl=None) -> ParseUserAgentPost:
        utility = self._utility
