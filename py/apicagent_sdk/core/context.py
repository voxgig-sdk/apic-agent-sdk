...
from apicagent_sdk.core.control import ApicAgentControl
...
from apicagent_sdk.core.helpers import get_ctx_prop, to_map
...
class ApicAgentContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        if isinstance(sp, ApicAgentSpec):
            self.spec = sp
        elif basectx is not None:
        ...
        if isinstance(r, ApicAgentResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, ApicAgentResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def make_error(self, code, msg):
        return ApicAgentError(code, msg, self)
