    ...
    def test_should_run_basic_flow(self):
        ...
        if setup.get("synthetic_only"):
            pytest.skip("live entity test uses synthetic IDs from fixture — "
                        "set APIC_AGENT_TEST_PARSE_USER_AGENT_GET_ENTID JSON to run live")
        client = setup["client"]
        ...
        parse_user_agent_get_ref01_data_dt0_loaded = parse_user_agent_get_ref01_ent.load(parse_user_agent_get_ref01_match_dt0, None)
...
def _parse_user_agent_get_basic_setup(extra):
    ...
    idmap_resolved = helpers.to_map(
        env.get("APIC_AGENT_TEST_PARSE_USER_AGENT_GET_ENTID"))
