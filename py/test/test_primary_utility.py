...
from apicagent_sdk.core.spec import ApicAgentSpec
from apicagent_sdk.core.result import ApicAgentResult
from apicagent_sdk.core.response import ApicAgentResponse
from apicagent_sdk.core.operation import ApicAgentOperation
from apicagent_sdk.core.error import ApicAgentError
...
def _err_from_map(m):
    ...
    if msg == "":
        return None
    code = m.get("code", "")
    return ApicAgentError(code, msg)
...
class TestPrimaryUtility:
    ...
    def test_feature_init_basic(self):
        init_client = ApicAgentSDK.test(None, None)
        ...
        class TestInitFeature(ApicAgentBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "initfeat"
                self.active = True
    ...
    def test_feature_init_inactive(self):
        ...
        class TestInitFeatureInactive(ApicAgentBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "nofeat"
                self.active = False
    ...
    def test_make_result_no_result(self):
        ...
        utility = client._utility
        ctx = _make_test_full_ctx(client, utility)
        ctx.spec = ApicAgentSpec({"step": "start"})
        ctx.result = None
    ...
    def test_make_spec_basic(self):
        ...
        spec_client = ApicAgentSDK.test(None, setup_opts)
    ...
    def test_prepare_auth_basic(self):
        ...
        auth_client = ApicAgentSDK.test(None, setup_opts)
