...
class ApicAgentTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = ApicAgentTestRunner.getenv("APICAGENT_TEST_LIVE")
        override = ApicAgentTestRunner.getenv("APICAGENT_TEST_OVERRIDE")
        ...
        explain = ApicAgentTestRunner.getenv("APICAGENT_TEST_EXPLAIN")
        if explain is not None and explain != "":
            m["APICAGENT_TEST_EXPLAIN"] = explain
