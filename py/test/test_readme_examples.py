# ApicAgent SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions ApicAgentSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both ApicAgentSDK(...) and ApicAgentSDK.test(...) become
#      ApicAgentSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "apicagent_sdk"
_SDK_CLASS = "ApicAgentSDK"
...
_ENTITIES = {
    "ParseUserAgentGet": "parse_user_agent_get",
    "ParseUserAgentPost": "parse_user_agent_post",
}
