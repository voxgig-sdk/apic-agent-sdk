# ApicAgent Python SDK



The Python SDK for the ApicAgent API — an entity-oriented client following Pythonic conventions.

The SDK exposes the API as capitalised, semantic **Entities** — for example `client.ParseUserAgentGet()` — each
...
release tag (`py/vX.Y.Z`, see [Releases](https://github.com/voxgig-sdk/apic-agent-sdk/releases)) or
...
```
py/
├── apicagent_sdk.py         -- Main SDK module
