...
|---|---|---|
| `ts/` | @voxgig-sdk/apic-agent-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/apic-agent-sdk \
      --repository voxgig-sdk/apic-agent-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/apic-agent-sdk` shows it, and
`npm trust revoke @voxgig-sdk/apic-agent-sdk --id=<id>` removes it.
