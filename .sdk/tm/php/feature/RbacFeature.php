...
class ApicAgentRbacFeature extends ApicAgentBaseFeature
{
    ...
    private function _required(ApicAgentContext $ctx): ?string
    {
    ...
    private function _reject(ApicAgentContext $ctx, string $required): void
    {
    ...
    private function _track(ApicAgentContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
