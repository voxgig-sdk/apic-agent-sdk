...
// ApicAgent SDK ratelimit feature
...
class ApicAgentRatelimitFeature extends ApicAgentBaseFeature
{
    ...
    private function _acquire(ApicAgentContext $ctx): void
    {
    ...
    private function _track(ApicAgentContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
