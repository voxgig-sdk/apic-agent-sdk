...
// ApicAgent SDK streaming feature
...
class ApicAgentStreamingFeature extends ApicAgentBaseFeature
{
    ...
    private function _iterate(ApicAgentResult $result): \Generator
    {
    ...
    private function _streamable(ApicAgentContext $ctx): bool
    {
