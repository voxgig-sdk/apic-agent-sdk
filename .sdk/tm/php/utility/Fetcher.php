...
// ApicAgent SDK utility: fetcher

class ApicAgentFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; ApicAgentSDK/1.0)';
    ...
    public static function call(ApicAgentContext $ctx, string $fullurl, array $fetchdef): array
    {
