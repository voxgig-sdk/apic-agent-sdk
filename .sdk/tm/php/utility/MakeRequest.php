...
// ApicAgent SDK utility: make_request

require_once __DIR__ . '/../core/Response.php';
require_once __DIR__ . '/../core/Result.php';

class ApicAgentMakeRequest
{
    public static function call(ApicAgentContext $ctx): array
    {
        ...
        if ($fetch_err) {
            ...
            $response = new ApicAgentResponse(['err' => $ctx->make_error('request_no_response', 'response: undefined')]);
        } elseif (is_array($fetched)) {
            $response = new ApicAgentResponse($fetched);
        } else {
