...
// ApicAgent SDK utility: transform_response

require_once __DIR__ . '/../core/Helpers.php';

class ApicAgentTransformResponse
{
    public static function call(ApicAgentContext $ctx): mixed
    {
        ...
        $transform = ApicAgentHelpers::to_map(\Voxgig\Struct\Struct::getprop($point, 'transform'));
        if (!$transform) {
            return null;
        }
