...
type ParseUserAgentPostEntity struct {
	name    string
...
func NewParseUserAgentPostEntity(client *core.ApicAgentSDK, entopts map[string]any) *ParseUserAgentPostEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *ParseUserAgentPostEntity) GetName() string { return e.name }
...
func (e *ParseUserAgentPostEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *ParseUserAgentPostEntity) Deleted() bool {
	return e.deleted
}


func (e *ParseUserAgentPostEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewParseUserAgentPostEntity(e.client, opts)
}

func (e *ParseUserAgentPostEntity) Data(args ...any) any {
...
func (e *ParseUserAgentPostEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
func (e *ParseUserAgentPostEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *ParseUserAgentPostEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}



func (e *ParseUserAgentPostEntity) Create(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
func (e *ParseUserAgentPostEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *ParseUserAgentPostEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *ParseUserAgentPostEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
