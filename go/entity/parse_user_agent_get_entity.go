...
type ParseUserAgentGetEntity struct {
	name    string
	client  *core.ApicAgentSDK
...
func NewParseUserAgentGetEntity(client *core.ApicAgentSDK, entopts map[string]any) *ParseUserAgentGetEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *ParseUserAgentGetEntity) GetName() string { return e.name }
...
func (e *ParseUserAgentGetEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *ParseUserAgentGetEntity) Deleted() bool {
	return e.deleted
}


func (e *ParseUserAgentGetEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewParseUserAgentGetEntity(e.client, opts)
}

func (e *ParseUserAgentGetEntity) Data(args ...any) any {
...
func (e *ParseUserAgentGetEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an ParseUserAgentGet; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *ParseUserAgentGetEntity) DataTyped(data ...ParseUserAgentGet) ParseUserAgentGet {
	if len(data) > 0 {
		return typedFrom[ParseUserAgentGet](e.Data(asMap(data[0])))
	}
	return typedFrom[ParseUserAgentGet](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through ParseUserAgentGet (all fields
// optional at the wire level).
func (e *ParseUserAgentGetEntity) MatchTyped(match ...ParseUserAgentGet) ParseUserAgentGet {
	if len(match) > 0 {
		return typedFrom[ParseUserAgentGet](e.Match(asMap(match[0])))
	}
	return typedFrom[ParseUserAgentGet](e.Match())
}
...
func (e *ParseUserAgentGetEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *ParseUserAgentGetEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// ParseUserAgentGetLoadMatch and returns an ParseUserAgentGet. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *ParseUserAgentGetEntity) LoadTyped(reqmatch ParseUserAgentGetLoadMatch, ctrl map[string]any) (ParseUserAgentGet, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return ParseUserAgentGet{}, err
	}
	return typedFrom[ParseUserAgentGet](res), nil
}



func (e *ParseUserAgentGetEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *ParseUserAgentGetEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *ParseUserAgentGetEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *ParseUserAgentGetEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *ParseUserAgentGetEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
