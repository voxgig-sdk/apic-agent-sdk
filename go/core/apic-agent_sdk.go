...
func (sdk *ApicAgentSDK) OptionsMap() map[string]any {
...
func (sdk *ApicAgentSDK) GetUtility() *Utility {
	return CopyUtility(sdk.utility)
}

func (sdk *ApicAgentSDK) GetRootCtx() *Context {
	return sdk.rootctx
}

func (sdk *ApicAgentSDK) Prepare(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *ApicAgentSDK) Direct(fetchargs map[string]any) (map[string]any, error) {
...
func (sdk *ApicAgentSDK) opAllowed(op string) bool {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return strings.Contains(allowOp, op)
}

func (sdk *ApicAgentSDK) opDenied(op string) map[string]any {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return map[string]any{
		"ok": false,
		"err": fmt.Errorf("ApicAgentSDK: %s: operation not allowed by"+
...
// gate by passing it.
func (sdk *ApicAgentSDK) rawRequest(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *ApicAgentSDK) Graphql(
	...
	if 0 < len(errors) {
		...
		res["ok"] = false
		res["err"] = fmt.Errorf("ApicAgentSDK: graphql: %s", msg)
		res["graphql"] = errors
	}
