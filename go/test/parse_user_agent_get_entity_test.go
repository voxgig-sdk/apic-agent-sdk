...
func TestParseUserAgentGetEntity(t *testing.T) {
	...
	t.Run("basic", func(t *testing.T) {
		...
		if setup.syntheticOnly {
			t.Skip("live entity test uses synthetic IDs from fixture — set APICAGENT_TEST_PARSE_USER_AGENT_GET_ENTID JSON to run live")
			return
		}
		client := setup.client
...
func parse_user_agent_getBasicSetup(extra map[string]any) *entityTestSetup {
	...
	entidEnvRaw := os.Getenv("APICAGENT_TEST_PARSE_USER_AGENT_GET_ENTID")
