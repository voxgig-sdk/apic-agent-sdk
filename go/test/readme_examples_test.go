...
const testSeed = `map[string]any{"entity": map[string]any{"parse_user_agent_get": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "parse_user_agent_post": map[string]any{"example_id": map[string]any{"id": "example_id"}}}}`
