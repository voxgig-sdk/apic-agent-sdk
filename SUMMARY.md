...
| --- | --- | --- | --- |
| ParseUserAgentGet | `load` | `GET /` | See reference |
| ParseUserAgentPost | `create` | `POST /` | See reference |

## Connect to the API

- Production server: `https://api.apicagent.com`
...
- `apic-agent_list`: List records for an entity. No active entity supports this operation.
- `apic-agent_load`: Load one record for an entity. Supported entities: `parse_user_agent_get`.
